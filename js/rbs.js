      ...
      series: [
        {
          ...
          data: [
            ...
            ["Incident Solar Power", "Lost as Heat 1", Math.round((incidentSolarPower - reflectedSolarPower - dcPowerFromPanel) * 100) / 100],
            ["Incident Solar Power", "DC Power From Panel", Math.round(dcPowerFromPanel * 100) / 100],
            ["DC Power From Panel", "Station-Keeping Power", Math.round(dcStationKeepingPower * 100) / 100],
            ["DC Power From Panel", "Power To Linear Motor", Math.round(powerToLinearMotor * 100) / 100],
            ["Power To Linear Motor", "Linear Motor Loss", Math.round(linearMotorLoss * 100) / 100],
            ["Power To Linear Motor", "Power To Ring", Math.round(powerToRing * 100) / 100],
            ["Power To Ring", "Energy for Nightime Use", Math.round(energyForNightime * 100) / 100],
            ["Power To Ring", "Energy for Daytime Use", Math.round(energyForDaytime * 100) / 100],
            ["Energy for Daytime Use", "Self Discharge Loss", Math.round(selfDischargeLoss * 100) / 100],
            ["Energy for Daytime Use", "Power To Linear Generators", Math.round(powerRemainingInRing * 100) / 100],
            ["Power To Linear Generators", "Linear Generator Loss", Math.round(linearGeneratorLoss * 100) / 100],
            ["Power To Linear Generators", "To Step-Up XFormer", Math.round(linearGeneratorOutputPower * 100) / 100],
            ["To Step-Up XFormer", "Step-Up XFormer Loss", Math.round(stepUpTransformerLoss * 100) / 100],
            ["To Step-Up XFormer", "To Vertical Trasmission Lines", Math.round(stepUpTransformerOutputPower * 100) / 100],
            ["To Vertical Trasmission Lines", "Vertical Power Transmission Loss", Math.round(verticalPowerTransmissionLoss * 100) / 100],
            ["To Vertical Trasmission Lines", "Delivered to Grid", Math.round(baseloadPowerDeliveredToGrid * 100) / 100],
          ],
                    type: "sankey",
          nodeWidth: 30,
          nodePadding: 100,
      ...
      series: [
        {
          keys: ["from", "to", "weight"],
          data: [
            ["Solar Panels", "Solar Assembly", Math.round(costOfSolarPanelArray * 100) / 100],
            ["Support Structure", "Solar Assembly", Math.round(costOfSolarPanelSupportingStructure * 100) / 100],
            ["Solar Actuators", "Solar Assembly", Math.round(costOfSolarActuators * 100) / 100],
            ["Solar Assembly", "Installation Capital Cost", Math.round(totalSatteliteComponentsCost * 100) / 100],
            ["Static Load Costs", "Installation Capital Cost", Math.round(costOfStaticLoad * 100) / 100],
            ["Energy Storage", "Installation Capital Cost", Math.round(costOfEnergyStorage * 100) / 100],
            ["Installation Capital Cost", "Total Capital Costs", Math.round((satelliteCapitalCost + costOfEnergyStorage + costOfStaticLoad) * 100) / 100],
          ],
          type: "sankey",
          nodeWidth: 30,
          nodePadding: 20,
